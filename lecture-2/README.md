...
* In this exercise we will add a single map to our code by adding this piece of code.
    ...
    Since ebpf programs can be executing on many cpu's at once we need synchronization of update to the maps.

    We can use this type of helper call to do that.
...
1. How do we incrementally both values, the count of packets and number of bytes together?
